      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          foreach($categories as $category) {
              ?>
              <li role="presentation" class="<?php if($category['id'] == $_GET['id']) {echo "active" ;} ?> nav-item"><a class="nav-link" href="produit.php?id=<?php echo $category['id']; ?>"><?php echo $category['libelle']; ?></a></li>
            <?php
          }
          ?>
        </ul>
